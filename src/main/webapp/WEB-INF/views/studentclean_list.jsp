<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.itlike.domain.StudentClean" %>
...
<head>
    ...
    <script type="text/javascript" src="./js/studentclean_list.js"></script>
