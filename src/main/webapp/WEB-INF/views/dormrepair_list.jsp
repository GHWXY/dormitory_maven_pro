<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.itlike.domain.DormRepair" %>
...
<head>
    ...
    <script type="text/javascript" src="./js/dormrepair_list.js"></script>
    <style type="text/css">
        .layui-table{
            text-align: center;
        }
